...
const LoginModal = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (userType === 'employee') {
      alert('Connexion réussie ! Redirection vers l\'espace Employé...');
    } else {
      alert('Connexion réussie ! Redirection vers l\'espace Patient...');
    }
  ...
  const handleBackdropClick = (e) => {
    if (e.target.className.includes('login-modal active')) {
      onClose();
    }
  };
  ...
  return (
    <div className={`login-modal ${isOpen ? 'active' : ''}`} onClick={handleBackdropClick}>
      <div className="login-modal-content single-panel">
        ...
        {/* Uniquement la partie droite (Formulaire) */}
        <div className="login-right-panel">
          ...
          <div className="login-footer">
            <p>
              {userType === 'patient' 
                ? "Première visite ? Contactez notre secrétariat pour créer votre compte."
                : "Vous êtes un professionnel ? Contactez l'administrateur."}
            </p>
          </div>
        </div>
      </div>
